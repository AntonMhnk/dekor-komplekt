              ...
              <div key={branch.id} className="branch-card">
                <div className="branch-header">
                  ...
                  <div className="branch-rating">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#ffc107" stroke="#ffc107" strokeWidth="2">
                      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                    </svg>
                    <span>{branch.rating}</span>
                    <span className="branch-reviews">({branch.reviews} отзывов)</span>
                  </div>
                </div>
                <div className="branch-info">
                  ...
                  <div className="branch-row">
                    ...
                    <a href={`tel:${branch.phoneLink}`}>{branch.phone}</a>
                  </div>
                  <div className="branch-row">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span className="branch-open">{branch.hours}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <div className="contact-card-content">
                ...
                <p className="contact-note">Единый номер для всех филиалов</p>
              </div>
            </div>
            ...
            <div className="contact-card">
              ...
              <div className="contact-card-content">
                ...
                <p className="contact-note">Без перерыва и выходных</p>
              </div>
            </div>
          ...
          <div className="contact-form-wrapper">
            ...
            <form className="contact-form">
              ...
              <div className="form-group">
                ...
                <textarea id="message" rows="4" placeholder="Опишите ваш запрос..."></textarea>
              </div>
